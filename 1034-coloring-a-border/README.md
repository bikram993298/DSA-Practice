<h2><a href="https://leetcode.com/problems/coloring-a-border/description/?envType=problem-list-v2&envId=ws347zag">1104. Coloring A Border</a></h2><h3>Medium</h3><hr><p>You are given an <code>m x n</code> integer matrix <code>grid</code>, and three integers <code>row</code>, <code>col</code>, and <code>color</code>. Each value in the grid represents the color of the grid square at that location.</p>
